...
![Version: 2.4.0](https://img.shields.io/badge/Version-2.4.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.14.4](https://img.shields.io/badge/AppVersion-4.14.4-informational?style=flat-square)
...
| dashboard.config.envFromConfigMap | string | `""` |  |
...
| dashboard.podSecurityContext.fsGroup | int | `1000` |  |
| dashboard.podSecurityContext.runAsGroup | int | `1000` |  |
| dashboard.podSecurityContext.runAsNonRoot | bool | `true` |  |
| dashboard.podSecurityContext.runAsUser | int | `1000` |  |
...
| dashboard.securityContext.runAsGroup | int | `1000` |  |
| dashboard.securityContext.runAsNonRoot | bool | `true` |  |
| dashboard.securityContext.runAsUser | int | `1000` |  |
...
| indexer.config.envFromConfigMap | string | `""` |  |
| indexer.config.indexerCustomConfig | string | `""` |  |
| indexer.config.indexerInternalUsersSecretName | string | `""` |  |
| indexer.config.javaOpts | string | `"-Xms2g -Xmx2g -Dlog4j2.formatMsgNoLookups=true"` |  |
| indexer.config.networkHost | string | `"0.0.0.0"` |  |
| indexer.config.nodesDN | string | `""` |  |
| indexer.config.reloadSecurityConfig | bool | `false` |  |
...
| indexer.image.tag | string | `""` |  |
| indexer.imagePullSecrets | list | `[]` |  |
| indexer.initContainers.resources.limits.cpu | string | `"100m"` |  |
| indexer.initContainers.resources.limits.memory | string | `"256Mi"` |  |
| indexer.initContainers.resources.requests.cpu | string | `"50m"` |  |
| indexer.initContainers.resources.requests.memory | string | `"128Mi"` |  |
| indexer.nodeSelector | object | `{}` |  |
| indexer.podAnnotations | object | `{}` |  |
| indexer.podLabels | object | `{}` |  |
| indexer.podSecurityContext.fsGroup | int | `1000` |  |
| indexer.priorityClassName | string | `""` |  |
| indexer.probes.liveness.enabled | bool | `true` |  |
| indexer.probes.liveness.failureThreshold | int | `3` |  |
| indexer.probes.liveness.initialDelaySeconds | int | `60` |  |
| indexer.probes.liveness.periodSeconds | int | `10` |  |
| indexer.probes.liveness.timeoutSeconds | int | `5` |  |
| indexer.probes.readiness.enabled | bool | `true` |  |
| indexer.probes.readiness.failureThreshold | int | `3` |  |
| indexer.probes.readiness.initialDelaySeconds | int | `60` |  |
| indexer.probes.readiness.periodSeconds | int | `10` |  |
| indexer.probes.readiness.timeoutSeconds | int | `5` |  |
| indexer.replicaCount | int | `1` |  |
| indexer.resourceValidation.enabled | bool | `false` |  |
| indexer.resourceValidation.maxCPU | string | `"8"` |  |
| indexer.resourceValidation.maxMemory | string | `"32Gi"` |  |
| indexer.resourceValidation.minCPU | string | `"500m"` |  |
| indexer.resourceValidation.minMemory | string | `"2Gi"` |  |
| indexer.resources | object | `{}` |  |
| indexer.securityContext.capabilities.add[0] | string | `"SYS_CHROOT"` |  |
| indexer.securityContext.runAsGroup | int | `1000` |  |
| indexer.securityContext.runAsUser | int | `1000` |  |
...
| manager.config.envFromConfigMap | string | `""` |  |
...
| manager.master.service.annotations | object | `{}` |  |
| manager.master.service.enabled | bool | `true` |  |
| manager.master.service.externalTrafficPolicy | string | `""` |  |
| manager.master.service.type | string | `"ClusterIP"` |  |
...
| manager.resourceValidation.enabled | bool | `false` |  |
| manager.resourceValidation.master.maxCPU | string | `"8"` |  |
| manager.resourceValidation.master.maxMemory | string | `"32Gi"` |  |
| manager.resourceValidation.master.minCPU | string | `"500m"` |  |
| manager.resourceValidation.master.minMemory | string | `"2Gi"` |  |
| manager.resourceValidation.worker.maxCPU | string | `"4"` |  |
| manager.resourceValidation.worker.maxMemory | string | `"16Gi"` |  |
| manager.resourceValidation.worker.minCPU | string | `"250m"` |  |
| manager.resourceValidation.worker.minMemory | string | `"1Gi"` |  |
| manager.service.annotations | object | `{}` |  |
| manager.service.enabled | bool | `true` |  |
| manager.service.externalTrafficPolicy | string | `"Cluster"` |  |
...
| manager.workers.service.annotations | object | `{}` |  |
| manager.workers.service.enabled | bool | `true` |  |
| manager.workers.service.externalTrafficPolicy | string | `""` |  |
| manager.workers.service.type | string | `"ClusterIP"` |  |
...
| tls.certManager.commonName.dashboard | string | `"dashboard.wazuh.example.com"` |  |
| tls.certManager.commonName.filebeat | string | `"filebeat.wazuh.example.com"` |  |
| tls.certManager.commonName.indexer.admin | string | `"admin.indexer.wazuh.example.com"` |  |
| tls.certManager.commonName.indexer.node | string | `"node.indexer.wazuh.example.com"` |  |
| tls.certManager.commonName.manager | string | `"manager.wazuh.example.com"` |  |
